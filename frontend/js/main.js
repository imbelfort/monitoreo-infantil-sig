...
function iniciarMonitoreoMadre() {
  ...
  actualizarEstadosLista(); // Nueva llamada inmediata
  ...
  ninos.forEach(nino => {
    ...
    div.innerHTML = `
      <div style="flex: 1;">
        ...
        <small>Código: <code>${nino.codigo_vinculacion || '---'}</code></small><br>
        <small>Estado: <span id="status-nino-${nino.id}" style="font-weight:bold; color: #95a5a6;">Cargando...</span></small>
      </div>
